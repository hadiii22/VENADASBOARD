        ...
        try {
            ...
            const response = await ai.models.generateContent({
                ...
                config: {
                    ...
                    systemInstruction: 'You are a friendly and encouraging business analyst for a small photography company. Provide short, positive, and actionable insights in Indonesian based on the data provided. Be concise.'
                }
            });
